...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split_3x5_3(
        ...
        KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                           KC_B,           KC_N,           KC_M,           LALT_T(KC_COMM),LGUI_T(KC_DOT), 
                                        LCTL_T(KC_ESC), LSFT_T(KC_SPC), LT(2,KC_TAB),                   LT(1,KC_ENT),   RSFT_T(KC_BSPC),LT(3,KC_RALT)),
    [1] = LAYOUT_split_3x5_3(
        KC_1,           KC_2,           KC_3,           KC_4,           KC_5,                           KC_6,           KC_7,           KC_8,           KC_9,           KC_0, 
        KC_GRV,         KC_MINS,        S(KC_MINS),     KC_EQL,         KC_LBRC,                        KC_RBRC,        S(KC_QUOT),     KC_QUOT,        KC_BSLS,        KC_SLSH, 
        KC_LGUI,        KC_LALT,        KC_LCTL,        KC_LSFT,        KC_CAPS,                        KC_RCTL,        KC_RSFT,        LCTL_T(KC_SCLN),KC_TRNS,        KC_TRNS, 
                                        KC_LCTL,        KC_TRNS,        KC_LSFT,                        KC_TRNS,        KC_TRNS,        KC_TRNS),
